...
import chardet
import re
user_name = ['* V A', '* Гр Кл', '* Гч Кл', '* См Дл',  '* Пч Дд', '* Ач Ер', '* Да Пр', '* Во Гб', '* Sn Pa', '* Кй Нй', '* Хв Мй', '* Бч Ай', '* Кк Мм', '* Кк Рн', '* Мн Ай']
user_id   = [  92960,    463065,    488679,    486774,     529387,    467234,    530286,    435953, 541052, 546179, 549344,           550727, 550729,      550970, 550971]
numbers   = []
