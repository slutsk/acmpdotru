...
import chardet
import re
user_name = ['* V A', '* Гр Кл', '* Гч Кл',  '* Пч Дд', '* Ач Ер', '* Да Пр',    '* Хв Мй', '* Бч Ай',  '* Вко Гб', '* Б АА', '* Мал Лаз', '* Рв Мй']
user_id   = [  92960,    463065,    488679,     529387,    467234,    530286,       549344,    550727,   435953,      254324,     328447 , 404944]
numbers   = []
