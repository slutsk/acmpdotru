...
import chardet
import re
user_name = ['* V A', '* Гр Кл', '* Гч Кл',  '* Пч Дд', '* Ач Ер', '* Да Пр',  '* Sn Pa',  '* Хв Мй', '* Бч Ай', '* Кк Мм', '* Кк Рн', '* Мн Ай',  '* Сц Яв', '* Бй Яв', '* Вко Гб', '* Б АА']
user_id   = [  92960,    463065,    488679,     529387,    467234,    530286,     541052,     549344,    550727,    550729,    550970,    550971,     552292 ,    553575,  435953, 254324]
numbers   = []
